...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.navigation_parties) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.content, PartyListFragment.newInstance()).commit();
        } else if (id == R.id.navigation_venues) {
            setTitle(R.string.drawer_item_venues_title);
            getSupportFragmentManager().beginTransaction().replace(R.id.content, VenueListFragment.newInstance()).commit();
        }
